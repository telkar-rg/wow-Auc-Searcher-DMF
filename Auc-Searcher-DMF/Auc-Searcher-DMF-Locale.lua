...
L["Header_Title"] = 	"Darkmoon Cards & Reagents search criteria"
L["Header_Desc"] = 		"Scan: Quest, Trade Goods (Elemental, Herb, Parts, Other)"

L["Money.deckprice"] = 		format("Budget per \124cffaa47ee%s\124r* (350 rep)", "Epic Deck")
...
L["Note.deckprice"] = 	format("*Items in the Auction House will be weighted according to their share in the complete \124cffaa47ee%s\124r (350 rep) and are only shown, if they fit inside the Budget.\n\n", "Epic Deck") .. format("The Budget of \124cff1eff00%s\124r will be assumed as the cost when weighing Reagents for TBC/WotLK cards.\n\n", "Primal Life/Eternal Life") .. format("In case of the \124cffc43b52%s\124r, this will be scaled to the equivalent of 350 rep.", "lesser Decks")
...
if GAME_LOCALE == "deDE" then
	...
	L["Header_Title"] = 	"Dunkelmond-Karten & Reagenzien - Suchkriterium"
	L["Header_Desc"] = 		"Scanne: Quest, Handwerkswaren (Elementar, Kräuter, Teile, Sonstige)"

	L["Note.deckprice"] = 	format("*Items im Auktionshause werden entsprechend ihrem Anteil am fertigen \124cffaa47ee%s\124r (350 Ruf) gewichtet und nur dann aufgeführt, wenn sie in das Budget passen.\n\n", "Epic Kartenset") .. format("Das Budget von \124cff1eff00%s\124r wird als Preis angenommen, wenn der Anteil der Reagenzien für TBC/WotLK Karten gewichtet wird.\n\n", "Urleben/Äonenleben") .. format("Im Falle der \124cffc43b52%s\124r wird dies auf 350 Ruf hochgerechnet.", "kleinen Kartensets")

	L["Money.deckprice"] = 		format("Budget pro \124cffaa47ee%s\124r* (350 Ruf)", "Epic Kartenset")
